    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h3 className="text-lg font-bold tracking-tight">Focus Tasks</h3>
          <p className="text-sm text-muted-foreground font-medium">
            {completedCount} of {totalCount} goals achieved
          </p>
        </div>
        <div className="flex items-center gap-2">
          <Button onClick={fetchTasks} variant="ghost" size="icon" className="h-9 w-9 rounded-xl text-muted-foreground">
