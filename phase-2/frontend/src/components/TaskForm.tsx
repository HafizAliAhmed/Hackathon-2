...
export function TaskForm({ onTaskCreated }: TaskFormProps) {
  ...
  return (
    <Card className="rounded-xl border border-border shadow-sm overflow-hidden bg-card/40">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="h-10 rounded-lg border-input bg-background/50 focus:bg-background"
              disabled={isLoading}
